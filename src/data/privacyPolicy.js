...
This privacy notice for CRYPTOASSETRECOVERY.COM, LLC ("Company," "we," "us," or "our"), describes how and why we might collect, store, use, and/or share ("process") your information when you use our services ("Services"), such as when you:

Visit https://cryptoassetrecovery.com/
Engage with us in other related ways, including any sales, marketing, or events
Questions or concerns? This privacy notice explains your privacy rights and choices. If you do not agree with our policies and practices, please do not use our Services. If you still have any questions or concerns, please contact us at info@cryptoassetrecovery.com.

Summary of Key Points
What personal information do we process? When you visit, use, or navigate our Services, we may process personal information depending on how you interact with CRYPTOASSETRECOVERY.COM, LLC and the Services, the choices you make, and the products and features you use.
...
Do we receive any information from third parties? We do not enrich our customer profiles with any information from third parties.
...
How do you exercise your rights? The easiest way to exercise your rights is by filling out our data subject request form available here: https://cryptoassetrecovery.com/contact/, or by contacting us. We will consider and act upon any request in accordance with applicable data protection laws.
...
14. ADVERTISING & FACEBOOK (META) BUSINESS TOOLS
15. CALIFORNIA "NOTICE AT COLLECTION" & DO NOT SELL OR SHARE
...
Website Hosting — Cloudflare.com
Website Performance Monitoring — Cloudflare.com
...
6. How Do We Keep Your Information Safe?
In Short: We aim to protect your personal information through a system of organizational and technical security measures. We have implemented appropriate and reasonable technical and organizational security measures designed to protect the security of any personal information we process.
...
If we learn that personal information from users less than 18 years of age has been collected, we will deactivate the account and take reasonable measures to promptly delete such data from our records. If you become aware of any data we may have collected from children under age 18, please contact us at info@cryptoassetrecovery.com.
...
If you have questions or comments about your privacy rights, you may email us at info@cryptoassetrecovery.com.
...
How do we use and share your personal information? CRYPTOASSETRECOVERY.COM, LLC collects and shares your personal information through: Beacons/Pixels/Tags. More information about our data collection and sharing practices can be found in this privacy notice.

You may contact us by email at info@cryptoassetrecovery.com, or by referring to the contact details at the bottom of this document. If you are using an authorized agent to exercise your right to opt out we may deny a request if the authorized agent does not submit proof that they have been validly authorized to act on your behalf.
...
CRYPTOASSETRECOVERY.COM, LLC has not sold any personal information to third parties for a business or commercial purpose in the preceding twelve (12) months. CRYPTOASSETRECOVERY.COM, LLC has disclosed the following categories of personal information to third parties for a business or commercial purpose in the preceding twelve (12) months: Category A. Identifiers; Category B. Personal information, as defined in the California Customer Records law; Category C. Characteristics of protected classifications under California or federal law; Category G. Geolocation data. The categories of third parties to whom we disclosed personal information for a business or commercial purpose can be found under "WHEN AND WITH WHOM DO WE SHARE YOUR PERSONAL INFORMATION?"
...
12. How Can You Contact Us About This Notice?
If you have questions or comments about this notice, you may email us at info@cryptoassetrecovery.com or by post to: CRYPTOASSETRECOVERY.COM, LLC, 5 Ross Rd., Durham, NH 03824, United States.

13. How Can You Review, Update, or Delete the Data We Collect from You?
Based on the applicable laws of your country, you may have the right to request access to the personal information we collect from you, change that information, or delete it. To request to review, update, or delete your personal information, please visit: https://cryptoassetrecovery.com/contact/.

14. Advertising & Facebook (Meta) Business Tools
Tools used. We use Meta Business Tools (e.g., Meta Pixel, Conversions API, and Custom Audiences) to measure performance, improve relevance, and reach interested audiences.

What may be shared. (i) Site/app event data (e.g., page views, form events); (ii) HTTP header data (e.g., IP address, user agent, referrer); and (iii) optional hashed contact identifiers you provide (e.g., email or phone) for advanced matching—each subject to your choices and applicable law.

What is never shared for ads. We do not transmit seed phrases, private keys, wallet backups (encrypted or not), password guesses, government IDs, full financial account numbers, or similarly sensitive categories to any advertising partner.

Roles & retention. For certain processing, Meta may act as an independent controller under its Business Tools Terms and may retain event data for up to two (2) years; Website Custom Audience membership can be retained up to 180 days (configurable).

Consent/opt-out. In the EEA/UK, we activate non-essential Advertising Tools only with your opt-in consent (you can withdraw any time). In the US, you may opt out of "sale"/"sharing" for cross-context behavioral advertising via Your Privacy Choices; we honor recognized browser opt-out signals (e.g., Global Privacy Control) where required by law.

15. California "Notice at Collection" & Do Not Sell or Share
Effective September 25, 2025: For California residents, we may "sell" or "share" (as those terms are defined by the California Consumer Privacy Act, as amended by the CPRA) certain non-sensitive categories of personal information (e.g., identifiers and internet/network activity) with advertising partners (e.g., Meta) for cross-context behavioral advertising.

Category	Purpose(s)	Retention	Sold/Shared for Ads?
Identifiers	Provide Services; security/fraud; communications; advertising/measurement	Up to 2 years (business records)	May be "shared" for cross-context behavioral advertising (e.g., Meta)
Internet/Network activity	Security; analytics; advertising/measurement	Up to 2 years	May be "shared" for cross-context behavioral advertising
Approx. geolocation	Fraud prevention; localization; advertising/measurement	Up to 2 years	May be "shared" as above
Sensitive client materials	Recovery services only; segregated with additional controls	As needed for services/legal	Never sold/shared for targeted ads
